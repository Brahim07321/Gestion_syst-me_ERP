...
@section('content')
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="card card-purple position-relative">
            <div class="card-body">
                <div class="card-icon">
                    <i class="fas fa-exclamation-triangle"></i>
                </div>

                <div class="card-number text-danger">{{ $lowStockCount }}</div>
        ...
        <div class="dashboard-cards">
            ...
            <div class="card card-blue ">
                <div class="card-body">
                    ...
                    <a href="/facture"><button class="card-more">More info<i
                                class="fas fa-arrow-right"></i></button></button></a>
                </div>
            </div>
