                ...
                <tbody>
                    @forelse($purchases as $purchase)
                        <tr>
                            ...
                            <td>{{ \Carbon\Carbon::parse($purchase->purchase_date)->format('d/m/Y') }}</td>                            <td>{{ number_format($purchase->total, 2) }} MAD</td>
                            <td>
                            ...
                            <td class="text-center">
                                <a href="{{ route('purchases.show', $purchase->id) }}" class="btn btn-sm btn-primary text-white">
