...
@section('content')
                ...
                <datalist id="products-list">
                    @foreach ($products as $product)
                        <option value="{{ $product->Referonce }} - {{ $product->Designation }}"
                            data-id="{{ $product->id }}" data-price="{{ $product->prace_bay }}">
                        </option>
                    @endforeach
                </datalist>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control product-search"
                                                    list="products-list" placeholder="Référence ou désignation..."
                                                    autocomplete="off" required>
                                                <input type="hidden" name="items[0][product_id]" class="product-hidden">
                                            </td>
                                            ...
                                            <td>
                                                <input type="number" name="items[0][buy_price]" class="form-control price"
                                                    step="0.01" min="0">
                                            </td>
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="productReferonce" name="Referonce"
                                    required>
                            </div>
    ...
    <script>
        ...
        document.getElementById('add-item').addEventListener('click', function() {
            ...
            <td>
            <input type="text" class="form-control product-search"
                list="products-list" placeholder="Référence ou désignation..." autocomplete="off" required>
            <input type="hidden" name="items[${index}][product_id]" class="product-hidden">
           </td>
            <td>
